-- Migration v2 : adresse par jour + prestation à domicile + connexion sociale
-- Idempotente (IF NOT EXISTS / IF EXISTS) — peut être rejouée sans risque.
-- Sur le serveur :
...
-- 2. Champs à domicile sur les rendez-vous
...
-- 4. Connexion sociale (Google / Facebook)
ALTER TABLE users
